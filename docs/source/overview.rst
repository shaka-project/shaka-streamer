...
Shaka Streamer requires `Python 3.12+`_.  Release versions of Shaka Streamer
can be installed or upgraded through ``pip3`` with:
...
.. _Python 3.12+: https://www.python.org/downloads/
